...
\frametitle{Problem definition: inverse problem}
	\begin{figure}
		\begin{overprint}
			...
			\onslide<2>	
			\centerline{\includegraphics[width=0.85\textwidth]{./figures/turbulence/channel/samplevels_spectrum_spanwise_refDNS_kc1.png}}
...
\frametitle{A generalization of non-local means}	
	\begin{tcolorbox}[colback=red!5!white,colframe=red!75!black]	
 	...
 	\vfill
	\centering
	\only<1>{\includegraphics[height=4.75cm]{./figures/NLM/lena.png}\captionof{figure}{Non-local means for denoising \cite{buades2005review}}}
	\only<2>{\includegraphics[height=4.75cm]{./figures/experimentalsetup/experiment_setup_fusion.png}\captionof{figure}{Propagation of small scales, inspired by video super-resolution \cite{protter2009generalizing}}}
\end{frame}
