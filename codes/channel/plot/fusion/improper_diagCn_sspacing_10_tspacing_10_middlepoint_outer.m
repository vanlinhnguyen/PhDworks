...
point_id_z_MAP=point_id_z_fulldomain-3; % truncated region in MAP as idsz_all_Z=4:284
...
nc1=netcdf('/data/DNSDATA/Fusion/BayesFusion_final/data/Ufluc_40Hz.nc','r');
nc2 = netcdf('/data/DNSDATA/Fusion/BayesFusion_final/data/variousspacings/Uinterp_spatialspacing_10.nc','r');
nc3=netcdf('/data/DNSDATA/Fusion/BayesFusion_final/data/variousspacings/Uinterp_timespacing_10.nc','r');
nc4 = netcdf('/data/DNSDATA/Fusion/BayesFusion_final/LinearRegression/RESULTS_PRED_RR_U_sspacing_10_tspacing_10.nc','r');
nc5=netcdf('/data/DNSDATA/Fusion/BayesFusion_final/fused/variousspacings/FusedData_40Hz_alldomain_diagCn_timespacing_10_spacespacing_10_improper.nc','r');
...
for t=1:num_blocks-1
    ...
    x_MAP_diagCn= [x_MAP_diagCn nc5{'Zhat_all'}(i_HWs_2save,point_id_y_MAP,point_id_z_MAP)];
end
...
% plot here
hold on
plot(RMSE_interp_spatial,'g-s','LineWidth',1,'MarkerEdgeColor','g','MarkerFaceColor','g','MarkerSize',6);  
plot(RMSE_interp_temporal,'m-o','LineWidth',1,'MarkerEdgeColor','m','MarkerFaceColor','m','MarkerSize',6);  
plot(RMSE_RR,'b-*','LineWidth',1,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',6);
...
leg =legend ({'$\mathbf{I}_s \mathbf{y}$','$ \mathbf{I}_t \mathbf{x}$','Penalized LSE','Fusion model',},'interpreter', 'latex','location','south'); 
