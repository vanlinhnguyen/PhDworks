...
leg={'$T_h/T_l=4$','$T_h/T_l=6$','$T_h/T_l=8$'};
...
export_fig('./figures/NLmean_interps_NRMSE_vary_timespacing2', '-a1','-q101','-eps','-painters'); % leave '-painters' can cause quality problems
close()
