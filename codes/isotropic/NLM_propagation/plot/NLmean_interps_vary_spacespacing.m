...
leg={'$D_h/D_l=3^2$','$D_h/D_l=4^2$','$D_h/D_l=6^2$'};
...
export_fig('./figures/NLmean_interps_NRMSE_vary_spacespacing2', '-a1','-q101','-eps','-painters'); % leave '-painters' can cause quality problems
close()
