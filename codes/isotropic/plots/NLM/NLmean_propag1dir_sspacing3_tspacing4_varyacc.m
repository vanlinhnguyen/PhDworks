...
filename_NLM1='/data/ISOTROPIC/NLM/interpdiff/server/NLmean_propag1dir_sspacing3_tspacing4_sim12_acc00_neighbor5_tau0100.nc';
filename_NLM2='/data/ISOTROPIC/NLM/interpdiff/server/NLmean_propag1dir_sspacing3_tspacing4_sim12_acc01_neighbor5_tau0100.nc';
filename_NLM3='/data/ISOTROPIC/NLM/interpdiff/server/NLmean_propag1dir_sspacing3_tspacing4_sim12_acc06_neighbor5_tau0100.nc';
filename_NLM4='/data/ISOTROPIC/NLM/interpdiff/server/NLmean_propag1dir_sspacing3_tspacing4_sim12_acc12_neighbor5_tau0100.nc';
...
legend({'q=01','q=03','q=13','q=25'},'Location','northwest','FontSize',fsize-6)
legend('boxoff')
box on ; 
...
export_fig('./figures/NLmean_propag1dir_spacing3_tspacing4_varyacc_NRMSE', '-a1','-q101','-eps','-painters'); % leave '-painters' can cause quality problems
close()
