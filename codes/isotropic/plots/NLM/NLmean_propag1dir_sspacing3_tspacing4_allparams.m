...
tex1 = text('String', '$\sigma=0.05,0.1,0.2,0.4$', ...
        'interpreter', 'latex',...
...
tex3 = text('String', '$\sqrt{s}=5,11,17$', ...
        'interpreter', 'latex',...
        'HorizontalAlignment', 'center',...
        'VerticalAlignment', 'Baseline', ...
        'FontUnits', 'pixels', ...
...
tex4 = text('String', '$\sqrt{r}=1,3,13,25$', ...
        'interpreter', 'latex',...
        'HorizontalAlignment', 'center',...
        'VerticalAlignment', 'Baseline', ...
        'FontUnits', 'pixels', ...
...
leg={'$\sigma=0.05$','$\sigma=0.1$','$\sigma=0.2$','$\sigma=0.4$'};
...
leg={'$\sqrt{s}=5$','$\sqrt{s}=11$','$\sqrt{s}=17$'};
...
leg={'$\sqrt{r}=1$','$\sqrt{r}=3$','$\sqrt{r}=13$','$\sqrt{r}=25$'};
...
% instead of subplot!
% different screen has different behaviors
