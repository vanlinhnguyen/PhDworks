...
filename_NLM1='/data/ISOTROPIC/NLM/interpdiff/server/NLmean_propag1dir_sspacing3_tspacing4_sim04_acc04_neighbor5_tau0100.nc';
filename_NLM2='/data/ISOTROPIC/NLM/interpdiff/server/NLmean_propag1dir_sspacing3_tspacing4_sim08_acc08_neighbor5_tau0100.nc';
...
%%
y = [NRMSE_NLmeans1_mean NRMSE_NLmeans2_mean NRMSE_NLmeans3_mean];
errY = [NRMSE_NLmeans1_std NRMSE_NLmeans2_std NRMSE_NLmeans3_std];
...
legend({'p=q=09','p=q=17','p=q=25'},'Location','northwest','FontSize',fsize-6)
legend('boxoff')
box on ; 
...
export_fig('./figures/NLmean_propag1dir_spacing3_tspacing4_varysim_NRMSE', '-a1','-q101','-eps','-painters'); % leave '-painters' can cause quality problems
close()
