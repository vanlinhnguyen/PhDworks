...
mf = sio.loadmat('/data/ISOTROPIC/regression/KRR_rbf_cv_alpha_gamma_sspacing3_tspacing4.mat', 
...
import os 
try:
   os.remove('/data/ISOTROPIC/data/KRR_rbf_sspacing3_tspacing4.nc')
except OSError:
   pass
ncfile2 = Dataset('/data/ISOTROPIC/data/KRR_rbf_sspacing3_tspacing4.nc', 'w') 
