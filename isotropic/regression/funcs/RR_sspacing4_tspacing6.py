...
mf = sio.loadmat('/data/ISOTROPIC/regression/RR_cv_alpha_sspacing4_tspacing6.mat', 
...
import os 
try:
   os.remove('/data/ISOTROPIC/data/RR_sspacing4_tspacing6.nc')
except OSError:
   pass
ncfile2 = Dataset('/data/ISOTROPIC/data/RR_sspacing4_tspacing6.nc', 'w') 
