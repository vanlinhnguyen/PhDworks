...
mf = sio.loadmat('/data/ISOTROPIC/regression/RR_cv_alpha_sspacing3_tspacing4.mat', squeeze_me=True, struct_as_record=False)
...
import os 
try:
   os.remove('/data/ISOTROPIC/data/RR_sspacing3_tspacing4.nc')
except OSError:
   pass
ncfile2 = Dataset('/data/ISOTROPIC/data/RR_sspacing3_tspacing4.nc', 'w') 
ncfile1 = Dataset('/data/ISOTROPIC/data/data_downsampled4.nc','r')
